...
enum PreferenceKey {
    ...
    /// Existing key: `defaults write com.tetherkit.app updateCheckDisabled -bool YES`.
...
struct SettingsPage: View {
    ...
    private var commandLineSection: some View {
        Section {
            ...
            if model.commandLineToolState == .installed {
                CopyableCommand(command: "tetherkit-cli --list")
                CopyableCommand(command: "sudo tetherkit-cli")
            }
        } header: {
    ...
    private var aboutSection: some View {
        Section(L(.settingsAboutSection)) {
            LabeledContent("libtetherkit",
                           value: TetherKitLibrary.versionInfo.version)
            LabeledContent("libusb", value: TetherKitLibrary.versionInfo.libusb)
            HStack {
